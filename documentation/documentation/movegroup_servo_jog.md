...
:::{note}
Selecteer in de `class UrROS2InterfaceConfig(ROS2InterfaceConfig)` in het `config_ur.py` bestand de ` action_type: ActionType = ActionType.MOVEGROUP_SERVO_JOG` om deze functionaliteit te gebruiken.
:::
